...
<!-- 1. 얼굴 분석 서비스 -> 모델을 json 객체 변환 - 자바api(pom.xml추가) -->
<!-- JSONObject total = new JSONObject(request.getAttribute("objectresult")); -->
<!-- 2. 사물 인식 서비스 -> 모델을 json 객체 변환 - 자바스크립트 JSON.parse -->
<script>
$(document).ready(function(){
	var json = JSON.parse('${objectresult}');  // el은 자바스크립트에서 사용가능
	...
	faceimage.onload = function(){
		...
		var y1 = boxes[i][0] * faceimage.height; //이미지 좌표 0~1 
		...
		mycontext.font = "bold 20px batang";
